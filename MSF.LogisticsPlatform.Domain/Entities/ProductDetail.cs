...
namespace MSF.LogisticsPlatform.Domain.Entities
{
    public class ProductDetail
    {
        ...
        public int ThermalPeformance { get; set; }
        ...
        public int ClarityOfManual { get; set; }
        public int Mobility { get; set; }
        public int QualityOfService { get; set; }
        public int Pricing { get; set; }
        public int FB_Stability { get; set; }
        public int FB_TendencyToAging { get; set; }
        public int FB_Modularity { get; set; }
        public int FB_Customization { get; set; }
        public int FB_Continuity { get; set; }
        public int FB_ThermalPeformance { get; set; }
        public int FB_NaturalLight { get; set; }
        public int FB_NaturalVentilation { get; set; }
        public int FB_Cleanability { get; set; }
        public int FB_TendencyToGetDirty { get; set; }
        public int FB_RequiredTraining { get; set; }
        public int FB_EaseDurationSafety { get; set; }
        public int FB_RequiredTools { get; set; }
        public int FB_ClarityOfManual { get; set; }
